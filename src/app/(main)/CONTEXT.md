...
## Recent Changes
- **2026-08-01**: Legal pages — added `/terms` (Terms of Service) page covering acceptance, service, accounts (13+), Creem merchant-of-record premium billing, conduct, IP, warranties/liability disclaimers, termination, and contact. Updated `/privacy` to add Creem (payment processor) to Third-Party Services, corrected hosting (Cloudflare edge + Render Stockfish backend), and cross-linked Terms. Legal links added to Profile "Manage Account" section and a footer on the home page.
