...
export function BottomNav({
  ...
  return (
    <motion.nav
      ...
      className="fixed bottom-0 left-0 right-0 z-30 border-t border-slate-200/80 bg-white/85 backdrop-blur-xl dark:border-slate-700/80 dark:bg-slate-900/85 pb-[max(12px,env(safe-area-inset-bottom,12px))]"
    >
