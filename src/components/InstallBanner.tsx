          ...
          <div className="mx-auto flex max-w-lg items-center justify-between gap-3">
            ...
            <div className="flex shrink-0 items-center gap-2">
              <a
                ...
                className="focus-ring min-h-[44px] min-w-[80px] rounded-lg bg-white px-3 py-1.5 text-[12px] font-semibold text-indigo-600 transition-colors hover:bg-white/90"
              >
                Install
              </a>
              <button
                onClick={() => setDismissed(true)}
                className="focus-ring flex min-h-[44px] min-w-[44px] items-center justify-center rounded-lg text-white/70 transition-colors hover:bg-white/10 hover:text-white"
                aria-label="Skip"
              >
                <X size={16} />
              </button>
