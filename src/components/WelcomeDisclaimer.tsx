      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-md overflow-y-auto rounded-[24px] border border-slate-200 bg-white p-4 shadow-2xl max-h-[calc(100dvh-2rem)] dark:border-slate-700/50 dark:bg-[var(--color-page-bg)] sm:p-5"
          >
            <button
              type="button"
              onClick={handleDismiss}
              className="focus-ring absolute right-3 top-3 flex h-11 w-11 items-center justify-center rounded-full text-slate-500 transition-colors hover:bg-slate-100 hover:text-slate-700 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-slate-200"
              aria-label="Close"
            >
              <X size={18} />
            </button>
            ...
            <div className="mb-3 text-center">
              <div className="flex items-center justify-center gap-0 text-2xl font-black tracking-tight">
                ...
                <span className="relative text-blue-600 dark:text-blue-500">
                  ...
                  <Crown
                    size={16}
                    className="absolute -left-0.5 -top-3 text-blue-500 dark:text-blue-400"
                    fill="currentColor"
                    strokeWidth={0}
                  />
                </span>
            ...
            <div className="mb-3 rounded-xl border border-slate-200 bg-slate-50 dark:border-slate-700/50 dark:bg-slate-800/30 p-3">
              <div className="relative mx-auto aspect-square w-full max-w-[140px] sm:max-w-[180px] onboarding-board">
                ...
                >
                  <span className="inline-block rounded-full bg-green-500/90 px-1.5 py-0.5 text-[11px] font-bold text-white shadow-[0_0_4px_rgba(34,197,94,0.5)]">
                    You
                  </span>
                </div>
                <div
            ...
            {/* Don't show again */}
            <label className="mb-3 flex min-h-[44px] cursor-pointer items-center gap-2.5">
              <input
                type="checkbox"
                checked={dontShow}
                onChange={(e) => setDontShow(e.target.checked)}
                className="h-4 w-4 shrink-0 rounded border-slate-300 bg-white text-amber-500 focus:ring-amber-500/40 focus:ring-offset-0 dark:border-slate-600 dark:bg-slate-800"
              />
            ...
            <button
              type="button"
              onClick={handleDismiss}
              className="focus-ring w-full min-h-[48px] rounded-2xl bg-gradient-to-r from-amber-500 to-orange-500 px-4 text-base font-bold text-slate-950 shadow-lg shadow-amber-500/20 transition-all hover:from-amber-400 hover:to-orange-400 active:scale-[0.98]"
            >
              Got it!
            </button>
          </motion.div>
