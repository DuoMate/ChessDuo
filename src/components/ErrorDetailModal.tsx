      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {details && (
              <div className="mb-4">
                <button
                  ...
                  className="focus-ring w-full text-xs text-gray-500 dark:text-slate-400 hover:text-gray-700 dark:hover:text-slate-300 transition-colors min-h-[44px] flex items-center justify-center gap-1 font-medium"
                >
            ...
            <button
              onClick={onClose}
              className="focus-ring w-full min-h-[44px] rounded-xl bg-red-600 hover:bg-red-500 text-white font-semibold text-sm transition-colors"
            >
              Dismiss
            </button>
          </motion.div>
