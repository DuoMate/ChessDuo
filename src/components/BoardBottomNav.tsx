...
function BoardBottomNavInner({ activeTab, onTabChange, onForward, onBackMove, onForwardMove, unreadChat, insightsLocked }: BoardBottomNavProps) {
  return (
    <nav
    ...
    >
      <div className="flex items-center justify-around h-14 w-[95%] max-w-md px-1 rounded-2xl border border-slate-200/60 bg-white/90 shadow-[0_8px_32px_rgba(2,6,23,0.12)] backdrop-blur-2xl dark:border-slate-700/50 dark:bg-[var(--color-page-bg)]/90 dark:shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
        ...
        <button
          ...
          className={`flex flex-col items-center justify-center gap-0.5 rounded-xl px-2 py-2 transition-[background-color,color,opacity,transform] duration-150 ease-out min-h-[44px] min-w-[44px] flex-1 ${
        ...
        <button
          ...
          className={`relative flex flex-col items-center justify-center gap-0.5 rounded-xl px-2 py-2 transition-[background-color,color,opacity,transform] duration-150 ease-out min-h-[44px] min-w-[44px] flex-1 ${
        ...
        <button
          type="button"
          onClick={onBackMove}
          className="flex flex-col items-center justify-center gap-0.5 rounded-xl px-2 py-2 transition-[background-color,color] duration-150 ease-out min-h-[44px] min-w-[44px] flex-1 text-slate-400 hover:text-slate-200"
...
export const BoardBottomNav = memo(BoardBottomNavInner)
