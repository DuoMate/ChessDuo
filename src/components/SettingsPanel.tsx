      ...
      >
        ...
        >
          <div className="flex items-center justify-between border-b border-slate-200/70 p-4 dark:border-slate-700/70">
            <button
              onClick={onClose}
              className="flex items-center gap-1.5 text-slate-500 transition-colors hover:text-slate-700 dark:text-slate-400 dark:hover:text-slate-200 min-h-[44px] min-w-[44px]"
            >
              <ArrowLeft size={16} />
          ...
          <div className="space-y-4 p-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                className="flex items-center gap-2 rounded-2xl bg-slate-100 px-3 py-2 transition-colors hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 min-h-[44px] min-w-[44px]"
