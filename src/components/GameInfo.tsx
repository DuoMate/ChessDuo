...
export function GameInfo({ 
  ...
  return (
    <div className="space-y-3">
      {/* Room code sharing */}
      {roomCode && (
        <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-3 shadow-sm backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-900/80">
      ...
      {/* Game over message */}
      {isGameOver && (
        <div className="rounded-3xl border border-amber-500/20 bg-amber-500/10 p-4 text-center shadow-sm">
