      ...
      <div className="grid grid-cols-3 gap-2">
        {skillLevels.map((level: SkillLevel) => (
          <button
            ...
            className={`focus-ring p-3 rounded-xl border-2 transition-all duration-200 text-center min-h-[44px] ${
              selectedLevel === level.level
                ? 'border-[var(--color-brand)] bg-[var(--color-brand-soft)] shadow-md dark:shadow-[0_0_20px_rgba(59,130,246,0.15)]'
