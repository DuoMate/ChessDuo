...
export function ResignConfirmModal({ onConfirm, onCancel }: ResignConfirmModalProps) {
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="fixed inset-0 bg-black/60 dark:bg-black/85 flex items-center justify-center z-[80] p-4"
    ...
    >
      ...
      >
        ...
        <div className="flex gap-3">
          <button
            onClick={onCancel}
            className="flex-1 py-3 rounded-xl bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-white font-medium text-sm transition-colors"
